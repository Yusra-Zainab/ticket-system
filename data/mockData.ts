...
export const mockProjects: Project[] = [
  { id: '1', name: 'AG Property Manager', client: 'Aristadou Group', status: 'Active', progress: 75, dueDate: '2026-12-31', startDate: '2026-03-01', budget: 84000, description: 'A unified property operations portal for tenants, leases, maintenance, and payments.', team: ['Ahmed Khan', 'Olivia Rhy', 'Phoenix Baker'] },
  { id: '2', name: 'PBT Merchant Console', client: 'PBT Payments', status: 'Critical', progress: 43, dueDate: '2026-09-20', startDate: '2026-04-18', budget: 120000, description: 'Real-time settlement, dispute, and merchant reporting experience.', team: ['Ahmed Khan', 'Lana Steiner'] },
  { id: '3', name: 'Northstar Analytics', client: 'Northstar Labs', status: 'On Track', progress: 68, dueDate: '2027-01-15', startDate: '2026-05-09', budget: 96000, description: 'Self-service analytics and experiment monitoring for product teams.', team: ['Olivia Rhy', 'Phoenix Baker'] },
  { id: '4', name: 'Cedar Commerce', client: 'Cedar Retail', status: 'Paused', progress: 31, dueDate: '2027-03-10', startDate: '2026-02-12', budget: 72000, description: 'Omnichannel inventory and storefront modernization program.', team: ['Lana Steiner'] },
  { id: '5', name: 'Halo Patient Portal', client: 'Halo Health', status: 'In Progress', progress: 56, dueDate: '2026-11-28', startDate: '2026-04-02', budget: 135000, description: 'Secure scheduling, messaging, and patient document access.', team: ['Ahmed Khan', 'Olivia Rhy'] },
];

...
import { ResourceNotificationRow } from "@/components/resource-portal/ResourceNotificationPopover";
import { cn } from "@/lib/utils";

const tabs = ["All", "Tickets", "Mentions", "Deadlines", "System"] as const;
type NotificationTab = (typeof tabs)[number];

export default function ResourceNotificationsList() {
  const { notifications, markRead, markAllRead } = useResourceNotifications();
